...
export function ShareButtons({ url, title, description }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-sm text-slate-600 mr-2">{t('share')}:</span>
      ...
      <button
        ...
        className="w-9 h-9 flex items-center justify-center rounded-full bg-sky-500 text-white hover:bg-sky-600 transition-colors"
        title="Telegram"
      >
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
