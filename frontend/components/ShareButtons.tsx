...
export function ShareButtons({ url, title, description, variant = 'inline' }: ShareButtonsProps) {
  ...
  const socialButtons = (
    <>
      ...
      <button
        ...
        className={`${iconBtn} bg-black text-white hover:bg-gray-800`}
        title="X (Twitter)"
      >
      ...
      <button
        ...
        className={`${iconBtn} bg-sky-500 text-white hover:bg-sky-600`}
        title="Telegram"
      >
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        className={`${iconBtn} bg-blue-700 text-white hover:bg-blue-800`}
        title="LinkedIn"
      >
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  if (variant === 'sidebar') {
    return (
      <div className="space-y-3">
        <div className="text-sm font-semibold text-slate-900">{t('share')}</div>
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="mr-2 text-sm text-slate-600">{t('share')}:</span>
      {socialButtons}
      {copyIconButton}
    </div>
  );
